...
| -------------------------------- | --------------------- | -------- | ---------------------- | ---------------------- |
| 👮 Участковый (мониторинг)       | каждые 10 мин (`:03`) | isolated | gemini-3-flash-preview | Проверка cron/disk/git |
| 🚨 BACKUP: Участковый            | каждые 10 мин (`:09`) | isolated | **gpt-4o-mini**        | Fallback мониторинг    |
| 🔧 Механик (починка)             | `:08,:38`             | isolated | gemini-3-flash-preview | Починка по incidents   |
| 🚨 BACKUP: Механик               | `:23,:53`             | isolated | **gpt-4o-mini**        | Fallback авторемонт    |
| 🕵️ Чекист (аудит)                | `:18`                 | isolated | gemini-3-flash-preview | Аудит incidents.jsonl  |
| 🚨 BACKUP: Чекист                | `:48`                 | isolated | **gpt-4o-mini**        | Fallback аудит         |
...
| 🚨 BACKUP: Ежемесячный аудит     | 1-е 12:00             | isolated | **gpt-5.2**            | Fallback аудит (+2ч)   |
...
> **Исключение:** Ежемесячный аудит (Optimizer) — основной `claude-opus-4-6`, backup `gpt-5.2` (+2ч).
