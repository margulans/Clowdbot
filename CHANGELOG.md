...
- Agents/Models: support Anthropic Sonnet 4.6 (`anthropic/claude-sonnet-4-6`) across aliases/defaults with forward-compat fallback when upstream catalogs still only expose Sonnet 4.5; set `contextWindow: 1_000_000` for Sonnet/Opus 4.6 forward-compat models to reflect their actual 1M context capacity.
